...
- **Product anchor:** `76aa4fbdae34454114479a6a3e39aa38847d05c5` (CODEQL-NON-CHANNELS-RATE-LIMITING-CLUSTER-01-LLM-AUTH, merge commit for PR #119, 2026-04-14). Four js/missing-rate-limiting alerts retired on live main (state=fixed, fixed_at=2026-04-14T15:58:44Z): #53 `auth.routes.ts:163` (pin-login), #55 `llm.routes.ts:91` (GET llm/config), #56 `llm.routes.ts:110` (POST llm/config), #57 `llm.routes.ts:242` (POST llm/test). Bounded edits in two files only (+40/-10). Prior anchor `9adc7fb13e35293ff866ea7717fed288933de965` retained the insecure-randomness retirement. Chain extends with `24abc8b` → `76aa4fb` (PR #119 merge) → LOCKED. **This closes Cluster 01 only (LLM/Auth) of the non-channel rate-limit lane; Cluster 02 (external-API, 6 alerts) and Cluster 03 (user-data CRUD, 9 alerts) remain carryover. Cluster 04 (3D-print, 1 alert) is locked-lane and excluded.**
